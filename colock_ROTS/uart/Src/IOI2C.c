...
//	GPIOB->CRH&=0XFFFF00FF;//PB10/11 推挽输出 //设置GPIO
//	GPIOB->CRH|=0X00003300;	   //PB10:SCL  PB11:SDA
	
	RCC->APB2ENR|=1<<3;//先使能外设IO PORTA时钟 							 
	GPIOB->CRH&=0XFF00FFFF;//PB12/13 推挽输出 //设置GPIO
	GPIOB->CRH|=0X00330000;	   //PB12:SCL  PB13:SDA
}
